...
#define TDB_DEAD_MAGIC (0xFEreformDEAD)
...
root@darkstar:/var/testpppd# tdbdump pppd2_budle3_025 
{
key(46) = "BUNDLE=\22paptest\22/local:63.68.61.70.74.65.73.74"
data(8) = "pppd3855"
}
{
key(52) = "BUNDLE_LINKS=\22paptest\22/local:63.68.61.70.74.65.73.74"
data(10) = "pppd3855;\00"
}
{
key(11) = "IFNAME=ppp0"
...
*/ //想数据库db中添加或者更新key和对应的data信息，通过flage标识，起取值为TDB_REPLACE等
